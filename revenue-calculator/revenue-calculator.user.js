...
// @updateURL   https://github.com/Ciberus/steam-scripts/raw/master/revenue-calculator/revenue-calculator.user.js
// @downloadURL https://github.com/Ciberus/steam-scripts/raw/master/revenue-calculator/revenue-calculator.user.js
...
function getPrice(data, gameId) {
  try {
    const firstKey = Object.keys(data)[0];
    debug && console.log(firstKey);
...
async function onLoaded() {
  ...
  const price = getPrice(pricesRes, gameId);
